...
public class EnterMarks extends JFrame implements ActionListener {
    ...
    EnterMarks() {
        setSize(1000, 500);
        setTitle("Result Upload Section");
        setLocation(300, 150);
        setLayout(null);
        ...
        image.setBounds(600, 25, 350, 250);
        add(image);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            try {
                ...
                String mrk1 = tfmarks1.getText();
                String mrk2 = tfmarks2.getText();
                String mrk3 = tfmarks3.getText();
                String mrk4 = tfmarks4.getText();
                String mrk5 = tfmarks5.getText();

                if (roll == null || roll.trim().isEmpty()
                        || sem == null || sem.trim().isEmpty()
                        || sub1 == null || sub1.trim().isEmpty()
                        || sub2 == null || sub2.trim().isEmpty()
                        || sub3 == null || sub3.trim().isEmpty()
                        || sub4 == null || sub4.trim().isEmpty()
                        || sub5 == null || sub5.trim().isEmpty()
                        || mrk1 == null || mrk1.trim().isEmpty()
                        || mrk2 == null || mrk2.trim().isEmpty()
                        || mrk3 == null || mrk3.trim().isEmpty()
                        || mrk4 == null || mrk4.trim().isEmpty()
                        || mrk5 == null || mrk5.trim().isEmpty()) {

                    JOptionPane.showMessageDialog(null, "Please fill in all required fields.", "Error", JOptionPane.ERROR_MESSAGE);
                } else {

                    String query1 = "insert into subject values('" + roll + "', '" + sem + "', '" + sub1 + "', '" + sub2 + "', '" + sub3 + "', '" + sub4 + "', '" + sub5 + "')";
                    ...
                    String query2 = "insert into marks values('" + roll + "', '" + sem + "', '" + mrk1 + "', '" + mrk2 + "', '" + mrk3 + "', '" + mrk4 + "', '" + mrk5 + "')";
