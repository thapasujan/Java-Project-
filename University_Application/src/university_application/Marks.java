...
public class Marks extends JFrame implements ActionListener  {
    ...
    Marks(String rollno) {
        ...
        JLabel heading = new JLabel("Purbanchal University");
        ...
        lblrollno.setFont(new Font("Times New Roman", Font.PLAIN, 16));
        add(lblrollno);

        JLabel lblsemester = new JLabel();
        lblsemester.setBounds(60, 130, 500, 20);
        lblsemester.setFont(new Font("Times New Roman", Font.PLAIN, 16));
        add(lblsemester);
        ...
        cancel.setBounds(170, 400, 120, 25);
